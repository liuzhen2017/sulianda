<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="授权账号" prop="authorizationNo">
        <el-input
          v-model="queryParams.authorizationNo"
          placeholder="请输入授权账号"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['express:express:add','warehouse:express:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['express:express:edit','warehouse:express:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['express:express:remove','warehouse:express:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['express:express:export','warehouse:express:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="expressList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="快递名称" align="center" prop="name" />
      <el-table-column label="授权账号" align="center" prop="authorizationNo" />
      <el-table-column label="授权码" align="center" prop="authorizationCode" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="快递名称" prop="name">
          <el-input v-model="form.name" placeholder="请输入快递名称" />
        </el-form-item>
        <el-form-item label="授权账号" prop="authorizationNo">
          <el-input v-model="form.authorizationNo" placeholder="请输入授权账号" />
        </el-form-item>
        <el-form-item label="快递API" prop="apiUrl">
          <el-input v-model="form.apiUrl" placeholder="请输入快递API" />
        </el-form-item>
        <el-form-item label="授权码" prop="authorizationCode">
...
<script>
import { listExpress, getExpress, delExpress, addExpress, updateExpress } from "@/api/express/express";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('express/express/export', {
        ...this.queryParams
